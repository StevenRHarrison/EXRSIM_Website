  ...
  const caseStudies = [
    {
      ...
      testimonial: {
        quote: 'EXRSIM\'s flood simulation scenarios have dramatically improved our preparedness. The realistic river modeling and multi-agency coordination features have been invaluable.',
        author: 'Tom Sampson',
        title: 'Chief, Emergency Management Agency',
    ...
    },
    {
      ...
      testimonial: {
        quote: 'The platform\'s ability to incorporate Indigenous community needs and protocols into wildfire response training has been groundbreaking for our operations.',
        author: 'Patricia Bear',
        title: 'Wildfire Operations Manager',
        organization: 'Alberta Wildfire'
      },
    ...
    },
    {
      ...
      testimonial: {
        quote: 'EXRSIM\'s mass casualty scenarios have transformed our emergency preparedness. Our medical staff now feel confident handling large-scale incidents.',
    ...
    },
    {
      ...
      testimonial: {
        quote: 'The pipeline emergency simulations have helped us achieve consistent, high-quality response capabilities across our entire network.',
    ...
    },
    {
      ...
      testimonial: {
        quote: 'EXRSIM\'s winter storm scenarios have revolutionized how we prepare for and respond to severe weather events across the Maritime region.',
        author: 'Jennifer MacLeod',
        title: 'Regional Emergency Coordinator',
        organization: 'Maritime EMO'
      },
              ...
              <div key={index} className="bg-exrsim-dark rounded-lg border border-gray-700 overflow-hidden">
                <div className={`grid grid-cols-1 lg:grid-cols-2 ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}>
                  ...
                  <div className={`p-8 lg:p-12 ${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                    ...
                    {/* Testimonial */}
                    <div className="bg-exrsim-gray/50 rounded-lg p-6 border border-gray-600">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-exrsim-orange text-sm">{study.testimonial.title}</div>
                        <div className="text-gray-400 text-sm">{study.testimonial.organization}</div>
                      </div>
                    </div>
                  </div>
                </div>
