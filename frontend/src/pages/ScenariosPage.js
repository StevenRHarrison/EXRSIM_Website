  ...
  const scenarios = [
    {
      ...
      // duration: '3-7 days',
      // participants: '50-200',
      description: 'Comprehensive wildfire response training including evacuation, suppression coordination, and inter-agency communication.',
      details: [
        'Wildfire behavior prediction and modeling',
        'Evacuation zone establishment and management',
        'Air and ground resource coordination',
        'Structure protection prioritization',
        'Smoke management and air quality monitoring',
