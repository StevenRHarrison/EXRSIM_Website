...
const ResourcesPage: React.FC = () => {
  const whitepapers = [
    {
      title: 'Emergency Preparedness in Canadian Winter Conditions',
  ...
  const webinars = [
    {
      title: 'Wildfire Response Coordination: Lessons from 2023 Season',
      presenter: 'Chief Patricia Bear, Alberta Wildfire',
      duration: '45 minutes',
      viewers: '1,200+',
      date: 'October 2024'
    },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {whitepapers.map((paper, index) => (
              <div key={index} className="bg-exrsim-dark rounded-lg p-6 border border-gray-700">
                ...
                <button className="w-full mt-4 btn-primary text-white py-2 rounded-lg font-medium flex items-center justify-center space-x-2">
