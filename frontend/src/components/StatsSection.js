  ...
  const stats = [
    {
      ...
      description: 'Emergency responders trained across Canada'
    },
    {
      icon: Building2,
      number: '500+',
      label: 'Organizations',
      description: 'Government agencies and private sector clients'
    },
    {
      icon: MapPin,
      number: '13',
      label: 'Provinces & Territories',
      description: 'Coast-to-coast coverage across Canada'
    },
    {
      icon: Trophy,
      number: '98%',
      label: 'Success Rate',
      description: 'Client satisfaction and training effectiveness'
    }
  ];
