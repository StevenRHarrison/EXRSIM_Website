      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              {/* <Shield className="h-8 w-8 text-exrsim-orange" /> */}
              <div className="flex flex-col">
                <img src="EXRSIM_Small.jpg"></img>
                {/* <span className="text-xl font-bold text-white">EXRSIM</span>
                <span className="text-xs text-gray-400 -mt-1">Emergency Response Simulator</span> */}
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-exrsim-orange transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-exrsim-orange transition-colors">Energy & Utilities</a></li>
              <li><a href="#" className="text-gray-400 hover:text-exrsim-orange transition-colors">Transportation</a></li>
              <li><a href="#" className="text-gray-400 hover:text-exrsim-orange transition-colors">Natural or Man-made</a></li>
              <li><a href="#" className="text-gray-400 hover:text-exrsim-orange transition-colors">Government</a></li>
              <li><a href="#" className="text-gray-400 hover:text-exrsim-orange transition-colors">Healthcare</a></li>
              <li><a href="#" className="text-gray-400 hover:text-exrsim-orange transition-colors">Industry</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            ...
            <a href="#" className="text-exrsim-orange hover:underline ml-1">Privacy Policy</a> | 
            <a href="#" className="text-exrsim-orange hover:underline ml-1">Terms of Service</a>
          </p>
        </div>
      </div>
    </footer>
